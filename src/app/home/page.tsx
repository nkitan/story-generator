...
import { Icons, AnimationWrapper, Wrapper } from "@/components";
...
import { features, perks, pricingCards, reviews } from "@/constants/home-content";
import { cn } from "@/lib/utils";
import { ArrowRight, ChevronRight, UserIcon, Zap } from "lucide-react";
import Image from "next/image";
import Link from "next/link";

import banner from "@/public/assets/dashboard.svg"
import brandicon from "@/public/icons/sparkles-dark.svg"
    ...
    return (
        <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
                ...
                <AnimationWrapper>
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1.5 capitalize">
                                <Image src={brandicon} alt="✨" width={24} height={24} className="w-4 h-4" />
                                introducing astra AI
                                <ChevronRight className="w-4 h-4" />
                            </span>
                        </button>

                        <div className="p-5 rounded-xl bg-background/70 flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-base">
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <AnimationWrapper>
                    <div id="section-features-home" className="max-w-md mx-auto text-start md:text-center">
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <AnimationWrapper>
                    <div id="section-pricing-home" className="max-w-md mx-auto text-start md:text-center">
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                <AnimationWrapper>
                    <LampContainer className="bg-transparent" theme="bg-background">
                        <div id="section-newsletter-home" className="flex flex-col items-center justify-center relative w-full text-center">
                ...
                <AnimationWrapper className="relative z-[999999]">
                    <div className="flex items-center justify-center w-full -mt-40">
                        <div className="bg-background/30 flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between w-full px-4 md:px-8 rounded-lg lg:rounded-2xl border border-border/80 py-4 md:py-8">
